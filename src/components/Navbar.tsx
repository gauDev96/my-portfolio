...
export default function Navbar({ onOpenCommandPalette, activeSection }: NavbarProps) {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative px-4 py-1.5 rounded-full text-xs font-medium font-mono uppercase tracking-widest cursor-none transition-colors duration-300 ${
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-slate-950/80 border border-slate-800 text-slate-400 hover:text-slate-200 transition-all flex items-center gap-2 cursor-none text-xs font-mono select-none"
