    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          WebkitTransform: `scaleX(${scrollProgress / 100}) translateZ(0)`,
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-cyan-500 to-blue-600 flex items-center justify-center border border-white/10 shadow-inner overflow-hidden relative">
              ...
              <span className="text-white font-display font-black text-sm select-none tracking-wider font-mono">
                GM
              </span>
            </div>
            <div className="hidden md:block">
              <span className="text-xs text-slate-500 block font-mono font-bold leading-none select-none tracking-tight">
                ENGINEER
              </span>
              <span className="font-display font-bold text-slate-100 tracking-wide text-xs select-none">
                GAURAB_M.
              </span>
            </div>
          </div>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="fixed top-16 left-0 right-0 z-[999] p-4 bg-slate-950/95 border-b border-slate-900 md:hidden font-mono flex flex-col gap-4 shadow-2xl"
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isActive && (
                      <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 shadow shadow-cyan-400" />
                    )}
                  </button>
                );
              })}
